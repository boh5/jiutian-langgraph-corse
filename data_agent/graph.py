...
def sql_inter(sql_query: str) -> str:
    ...
    connection = pymysql.connect(
        host=host, user=user, passwd=db_pw, db=db, port=int(port), charset="utf-8"
    )
...
def fig_inter(py_code: str, fname: str) -> str:
    ...
    # ✅ 设置图像保存路径（你自己的绝对路径）
    base_dir = r"D:\Files\codes\python_projects\jiutian-langgraph-corse\agent-chat-ui\apps\web\public"
